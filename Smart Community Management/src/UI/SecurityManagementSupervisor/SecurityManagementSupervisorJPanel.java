...
public class SecurityManagementSupervisorJPanel extends javax.swing.JPanel {
    ...
    int row,col;
    public SecurityManagementSupervisorJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization ) {
        initComponents();
...
private void populateTable() {
    ...
    private void displayEmployes() {
                ...
                for(UserAccount userAccount : organization.getUserAccountDirectory().getAccountList()){
                    if (userAccount.getRole() instanceof CommunitySecurityManagementWorkerRole) comboEmergencyEmploye.addItem(userAccount);
