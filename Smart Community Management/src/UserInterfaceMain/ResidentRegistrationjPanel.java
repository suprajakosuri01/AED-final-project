...
import Business.WorkQueue.ResidentRegristrationRequest;
 ...
 * @author adepu
 */
public class ResidentRegistrationjPanel extends javax.swing.JPanel {
    ...
    public ResidentRegistrationjPanel(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
...
// Recipient's email ID needs to be mentioned.
        String to = emailId;
        String from = "kosuri.sa@northeastern.edu";
        String pass = "Suppu@01";
