 ...
 private void populateComboBox()
    {
        ...
        for (Organization.Type type : Organization.Type.values()){
            ...
            {
                if(enterprise instanceof UtilityManagementEnterprise)
                {
                    
                     boxOrganization.addItem(Organization.Type. TrashRemoval);
                     boxOrganization.addItem(Organization.Type.Security);
                     boxOrganization.addItem(Organization.Type.ElectricityMaintainance);
                     boxOrganization.addItem(Organization.Type.DrinkingWater);
                    
                     break;
                }
                else if(enterprise instanceof SafetyEnterprise)
                {
                    
                     boxOrganization.addItem(Organization.Type.DisasterManagement);
                     break;
                    
                }
                else if(enterprise instanceof MedicalHelpEnterprise)
                {
                     boxOrganization.addItem(Organization.Type.Government);
                     boxOrganization.addItem(Organization.Type.NGO);
                     break;
                }
